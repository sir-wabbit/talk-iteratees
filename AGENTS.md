...
- Canonical repo target: `talk-iteratees`. Useful entrypoints: `dev project show talk-iteratees`, `dev build talk-iteratees`, `dev check talk-iteratees`.
- Setup-managed files are regenerated with `dev setup talk-iteratees`; avoid hand-editing stamped generated files.
